                            ...
                            <div className="space-y-6">
                                {timeline.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="rounded-[34px] border border-black/6 bg-white/78 backdrop-blur-md p-7 shadow-[0_24px_60px_rgba(36,11,14,0.08)]">
                                            <p className="text-sm font-exo font-bold uppercase tracking-[0.24em] text-custom-red mb-3">
                                                {item.year}
                                            </p>
                                            <h3 className="text-2xl md:text-3xl font-exo font-bold text-custom-bkred mb-4 leading-tight">
                                                {item.title}
                                            </h3>
